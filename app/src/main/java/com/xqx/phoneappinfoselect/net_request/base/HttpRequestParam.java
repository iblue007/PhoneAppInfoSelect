...
import com.xqx.phoneappinfoselect.DigestUtil;
import com.xqx.phoneappinfoselect.Global;
import com.xqx.phoneappinfoselect.NetLibUtil;
import com.xqx.phoneappinfoselect.ScreenUtil;
...
//    }
     ...
     * @param jsonParams
     */
    public static void addGlobalLauncherRequestValue(HashMap<String, String> paramsMap, String jsonParams,String terminalID ) {
        ...
        try {
            ...
            String BodyEncryptType = 0+"";
            String TerminalID = terminalID;
            String KEY = "6B18F17F-DD18-124F-D38B-928268FB69E2";

            paramsMap.put("NetMode", netMode);
            paramsMap.put("ProtocolVersion", ProtocolVersion);
            paramsMap.put("TerminalID", terminalID);
            paramsMap.put("Sign",DigestUtil.md5Hex(netMode+ProtocolVersion+TerminalID+jsonParams+KEY));
            paramsMap.put("BodyEncryptType", BodyEncryptType);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

//    public static void addGlobalLauncherRequestValue4TerminalID(HashMap<String, String> paramsMap, String jsonParams, String sessionId) {
//        Context ctx = Global.getApplicationContext();
//        if (paramsMap == null)
//            return;
//        if (jsonParams == null) {
