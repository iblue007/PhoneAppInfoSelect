...
public class ZipTool
{
	...
	// 已经操作过了
	public static final int ZIPOPTION_REDO = 6;
	...
	/**
	 * 压缩文件方法,可以压缩多个文件或者目录
	 * @param newZipPath String 生成压缩文件的路径
	 * @param wantZipPaths String[] 需要压缩的文件条目
	 */
	 ...
	 * @param zos ZipOutputStream 压缩文件的输出流
	 * @param zipFile File 需要压缩的文件或文件夹
	 * @param baseDir String 压缩文件夹中的递归路径,使用时直接传入空值即可
	 */
