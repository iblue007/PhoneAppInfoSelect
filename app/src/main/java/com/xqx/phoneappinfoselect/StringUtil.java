...
public final class StringUtil {
	...
	public static String parseShortNum(long num){
		if (num / 10000 == 0) {
			...
			return new DecimalFormat("#.0").format(num / (10000 * 1.0d)) + "万";
		} else if (num / 100000000L == 0) {
			return new DecimalFormat("#.0").format(num / (10000000L * 1.0d)) + "千万";
		} else {
			return new DecimalFormat("#.0").format(num / (100000000L * 1.0d)) + "亿";
		}
	}
